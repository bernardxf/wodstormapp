var crossfitApp = angular.module('crossfitApp', ['ngRoute','AppControllers','AppDirectives', 'AppFilters', 'AppServices', 'ngResource']);

crossfitApp.config(['$routeProvider',function($routeProvider){
	var templatePath = 'www';
	$routeProvider.when('/', {
		...
		templateUrl: templatePath + '/plano.html',
		controller: 'PlanoController'
	}).when('/cad_plano/:plano?', {
		templateUrl: templatePath + '/cad_plano.html',
		controller: 'PlanoController'
	}).when('/formapagamento', {
		templateUrl: templatePath + '/formapagamento.html',
		controller: 'FormaPagamentoController'
	}).when('/cad_formapagamento/:formapagamento?', {
		templateUrl: templatePath + '/cad_formapagamento.html',
		controller: 'FormaPagamentoController'
	}).when('/desconto', {
		templateUrl: templatePath + '/desconto.html',
		controller: 'DescontoController'
	}).when('/cad_desconto/:desconto?', {
		templateUrl: templatePath + '/cad_desconto.html',
		controller: 'DescontoController'
	}).when('/estacionamento', {
		templateUrl: templatePath + '/estacionamento.html',
		...
		templateUrl: templatePath + '/aluno.html',
		controller: 'AlunoController'
	}).when('/cad_aluno/:aluno?', {
		templateUrl: templatePath + '/cad_aluno.html',
		controller: 'AlunoController'
	}).when('/contrato/:aluno', {
		templateUrl: templatePath + '/contrato.html',
		controller: 'ContratoController'
	}).when('/cad_contrato/:aluno/:contrato?', {
		templateUrl: templatePath + '/cad_contrato.html',
		controller: 'ContratoController'
	}).when('/relaluno', {
		templateUrl: templatePath + '/relaluno.html',
		controller: 'RelAlunoController'
	}).when('/relalunosplano', {
		templateUrl: templatePath + '/relalunosplano.html',
		controller: 'RelAlunosPlanoController'
	}).when('/relAniversariantes', {
		templateUrl: templatePath + '/relatorio-template.html',
		controller: 'RelatorioController'
	}).when('/servico', {
		templateUrl: templatePath + '/servico.html',
		controller: 'ServicoController'
	}).when('/relmetricacontrato', {
		templateUrl: templatePath + '/relmetricacontrato.html',
		controller: 'RelMetricaContratoController'
	}).when('/relpresenca', {
		templateUrl: templatePath + '/relpresenca.html',
		controller: 'RelPresencaController'
	}).when('/cad_servico/:servico?', {
		templateUrl: templatePath + '/cad_servico.html',
		controller: 'ServicoController'
	}).when('/presenca', {
		templateUrl: templatePath + '/presenca.html',
		controller: 'PresencaController'
	}).when('/cad_presenca/:aula?', {
		templateUrl: templatePath + '/cad_presenca.html',
		controller: 'PresencaController'
	}).when('/relaula', {
		templateUrl: templatePath + '/relaula.html',
		controller: 'RelAulaController'
	}).when('/relservico', {
		templateUrl: templatePath + '/relservico.html',
		controller: 'RelServicoController'
	}).when('/perfil', {
		templateUrl: templatePath + '/perfil.html',
		controller: 'PerfilController'
	}).when('/usuario', {
		templateUrl: templatePath + '/usuario.html',
		controller: 'CadastroUsuarioController'
	}).when('/cad_usuario/:usuario?', {
		templateUrl: templatePath + '/cad_usuario.html',
		controller: 'CadastroUsuarioController'
	}).when('/financeiro', {
		templateUrl: templatePath + '/financeiro.html',
		controller: 'FinanceiroController'
	}).when('/financeiro/cad_movimento/:financeiro?', {
		templateUrl: templatePath + '/cad_fin_movimento.html',
		controller: 'FinanceiroController'
	}).when('/leaderboard', {
		templateUrl: templatePath + '/leaderboard.html',
		controller: 'LeaderboardController'
	}).when('/buscar_leaderboard', {
		templateUrl: templatePath + '/buscar_leaderboard.html',
		controller: 'LeaderboardController'
	}).when('/consultaLeaderboard/:dataLeaderboard/:organizacao', {
		templateUrl: templatePath + '/leaderboard_externo.html',
		controller: 'LeaderboardExternoController'
	}).when('/presenca_salao', {
		templateUrl: templatePath + '/presenca_salao.html',
		controller: 'PresencaSalaoController'
	}).when('/configuracao', {
		templateUrl: templatePath + '/configuracao.html',
		controller: 'ConfiguracaoController'
	}).when('/logout', {
		templateUrl: templatePath + '/logout.html',
		controller: 'LogoutController'
	}).otherwise({ redirectTo: '/404', templateUrl: templatePath + '/page404.html', controller: 'Page404Controller' });
