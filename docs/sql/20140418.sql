...
-- alter table `usuario` add column `id_grupo_usuario`INT(11) NOT NULL;
alter table `usuario` add constraint `fk_usuario_grupo_usuario1` FOREIGN KEY (`id_grupo_usuario`) REFERENCES `grupo_usuario` (`id_grupo_usuario`);
